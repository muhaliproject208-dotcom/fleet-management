...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'inspections.exceptions.custom_exception_handler',
...
# CORS Configuration - allow override via environment variable
CORS_ALLOWED_ORIGINS_ENV = env_config('CORS_ALLOWED_ORIGINS', default='')
